  ...
  return (
    <div className="min-h-screen bg-dark flex items-center justify-center p-4">
      <div className="bg-darker rounded-xl shadow-2xl p-8 w-full max-w-md">
        ...
        <p className="text-gray-400 text-center mb-6">Masukkan password baru Anda</p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full bg-gray-800 text-white border border-gray-600 rounded-lg px-4 py-2.5 focus:outline-none focus:border-primary" required minLength={6} />
          </div>
